    ...
    public event D? D4;
            ...
            VerifyAcrossCompilations(
                ...
                new[] { 
                    ...
                    //     public event D D1;
                    Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "D1").WithArguments("event", "D1", "Consider declaring the event as nullable.").WithLocation(8, 20),
    ...
    public C()
    {
        ...
        var s2 = Prop == null ? """" : Prop;
            ...
            comp.VerifyDiagnostics(
                ...
                //     public C()
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C").WithArguments("property", "Prop", "Consider declaring the property as nullable.").WithLocation(5, 12));
...
class C
{
    ...
    static string? GetNullableString() => null;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static string s_data;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "s_data").WithArguments("field", "s_data", "Consider declaring the field as nullable.").WithLocation(6, 27),
    ...
    static void M(object? o)
    {
        ...
        _ = c2.GetT;
            ...
            comp.VerifyDiagnostics(
                    ...
                    //     public T GetT { get; }
                    Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "GetT").WithArguments("property", "GetT", "Consider declaring the property as nullable.").WithLocation(4, 14));
    ...
    static void M(object? o)
    {
        ...
        _ = c2.GetT;
            ...
            comp.VerifyDiagnostics(
                    ...
                    //     public T GetT;
                    Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "GetT").WithArguments("field", "GetT", "Consider declaring the field as nullable.").WithLocation(4, 14),
