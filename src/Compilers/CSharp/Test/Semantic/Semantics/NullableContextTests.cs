...
#nullable enable
    ...
    S(object obj) : this() { }
            ...
            verify(source, expectedAnalyzedKeys: new[] { ".ctor" },
                ...
                //     S(object obj) : this() { }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "S").WithArguments("field", "F1", "Consider declaring the field as nullable.").WithLocation(6, 5)
                );
...
#nullable enable
    static object P2 { get; set; }
            ...
            verify(source, expectedAnalyzedKeys: new[] { ".cctor" },
                ...
                //     static object P2 { get; set; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P2").WithArguments("property", "P2", "Consider declaring the property as nullable.").WithLocation(6, 19));
...
#nullable disable
    static object P2 { get; set; }
            ...
            verify(source, expectedAnalyzedKeys: new[] { ".ctor" },
                ...
                //     object P1 { get; set; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P1").WithArguments("property", "P1", "Consider declaring the property as nullable.").WithLocation(4, 12));
...
#nullable enable
    static event D E2;
            ...
            verify(source, expectedAnalyzedKeys: new[] { ".cctor" },
                ...
                //     static event D E2;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "E2").WithArguments("event", "E2", "Consider declaring the event as nullable.").WithLocation(8, 20));
...
#nullable disable
    static event D E2;
            ...
            verify(source, expectedAnalyzedKeys: new[] { ".ctor" },
                ...
                //     event D E1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "E1").WithArguments("event", "E1", "Consider declaring the event as nullable.").WithLocation(6, 13));
